<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddCountry.aspx.cs" Inherits="OrderApp.AddCountry" MasterPageFile="~/MainMaster.Master" enableeventvalidation="false" viewstateencryptionmode="Never" %>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <asp:TextBox ID="txtCountryName" CssClass="form-control" runat="server" OnTextChanged="txtCountryName_TextChanged" AutoPostBack="true"></asp:TextBox>
