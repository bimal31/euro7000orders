...
namespace OrderApp
{
    public partial class AddDealerOrderSchemeNew : System.Web.UI.Page
    {
        ...
        public static string SaveData(string data, string productFreedata, string OrderProductDetails)
        {
             ...
             List<OrderProductDetailDataNew> OrderProductDetailDatadtl = new List<OrderProductDetailDataNew>();
             List<OrderFreeProductNew> OrderFreeProductdtl = new List<OrderFreeProductNew>();
            ...
            OrderFreeProductNew OrderFreeProductdtl1 = new OrderFreeProductNew();
            OrderProductDetailDataNew OrderProductDetailDatadtl1 = new OrderProductDetailDataNew();
            ...
            if (Convert.ToString(productFreedata1[0]) != "" && Convert.ToString(productFreedata1[0]) != "null")
            {
                ...
                {
                    OrderFreeProductdtl1 = new JavaScriptSerializer().Deserialize<OrderFreeProductNew>(tag.ToString());
            ...
            if (Convert.ToString(OrderProductDetails1[0]) != "" && Convert.ToString(OrderProductDetails1[0]) != "null")
            {
                ...
                {
                    OrderProductDetailDatadtl1 = new JavaScriptSerializer().Deserialize<OrderProductDetailDataNew>(tag.ToString());
        ...
        public static string xmlOrderFreeCreate(List<OrderFreeProductNew> OrderFreeProductdtl)
        {
            string XML = "";
            try
            {
        ...
        public static string xmlOrderProductDetail(List<OrderProductDetailDataNew> OrderProductDetailDatadtl)
        {
...
public class OrderProductDetailDataNew
{
...
public class OrderFreeProductNew
{
